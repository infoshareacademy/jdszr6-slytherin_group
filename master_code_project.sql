...
-- nadanie odpowiedniego typu danym czasowym
...
-- nadanie wartości odpowienim porom dnia
...
-- ilość przejazdów na dni tygodnia ogółem
...
-- średni czas i odległość przejazdów z podziałem na rok-miesiąc + dzień tygodnia
...
-- ilość przejazdów ogółem z podziałem na poszczególne godziny
